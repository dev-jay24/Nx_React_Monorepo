...
import { ROUTES, toAbsoluteUrl } from '@msr-monorepo/shared-utils';
...
const items: any[] | undefined = [
  ...
  // createMenuItem(ROUTES.reactQueryDemo, 'Transport Management', '3', <UserOutlined />),
  createMenuItem(
  ...
  // createMenuItem(ROUTES.reactQueryDemo, 'Commission Management ', '6', <UserOutlined />),
  // createMenuItem(ROUTES.reactQueryDemo, 'Payment Management ', '7', <UserOutlined />),
  ...
  createMenuItem(
    ...
    [
      ...
      createMenuItem(ROUTES.commissionManagement, 'Privacy Policy', '9'),
